          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (ctx, i) => CartItem(
                id: ref.read(cartInfoProvider.notifier).items[i]!.id,
                quantity:
                    ref.read(cartInfoProvider.notifier).items[i]!.quantity,
                name: ref.read(cartInfoProvider.notifier).items[i]!.productName,
                price: ref.read(cartInfoProvider.notifier).items[i]!.price,
              ),
            ),
          )
        ]));
